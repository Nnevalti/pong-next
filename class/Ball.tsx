export class Ball {
	...
	constructor(canvasWidth, canvasHeight, r, speed, maxSpeed, acceleration, p1, p2) {
	...
	update(score, gameConstants, secondPassed) {
		...
		if(this.x - this.r <= 0 && this.goal === false)
		{
			score.p2_Score++;
			this.goal = true;
			gameConstants.playerGoal.p2 = true;
			return ;
		}
		// Goal Player two
		if(this.x + this.r >= this.canvasWidth && this.goal === false)
		{
			score.p1_Score++;
			this.goal = true;
			gameConstants.playerGoal.p1 = true;
			return ;
		}
		this.goal = false;
		gameConstants.playerGoal.p1 = false;
		gameConstants.playerGoal.p2 = false;
		return ;
	}
}
